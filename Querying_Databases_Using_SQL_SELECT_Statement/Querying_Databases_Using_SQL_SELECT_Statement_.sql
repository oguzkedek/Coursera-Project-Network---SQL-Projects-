...
/*
Finds any values that have "ar" in any position
...
/*
Finds any values that start with "Mar" and are 4 characters in length
...
/*
Finds any values that doesn't have "Mar" in any position
*/
...
/*
retrieve a list of all employees who were employed on or before 1st of February, 1990
*/
...
SELECT DISTINCT(first_name), COUNT(*) AS Name_Counts
FROM employees
GROUP by first_name
ORDER BY 2 DESC